...
Category.create!([
  ...
  { name: "sm biz ads", url: "small-biz-ads", parent_id: 2 },
  { name: "travel/vac", url: "travel-vac", parent_id: 2 },
  { name: "write/ed/tran", url: "write-edit-translate", parent_id: 2 },
])
...
Category.create!([
  ...
  { name: "real estate for sale", url: "real-estate", parent_id: 4 },
